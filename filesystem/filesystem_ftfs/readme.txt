 /**
  @page " filesystem_ftfs "  demo
  
  @verbatim
  ******************** (C) COPYRIGHT 2016 MXCHIP MiCO SDK*******************
  * @file    filesystem_ftfs/readme.txt 
  * @author  MDWG (MiCO Documentation Working Group)
  * @version v2.4.x
  * @date    28-March-2017
  * @brief   Description of the  "filesystem_ftfs "  demo.
  ******************************************************************************


@par Demo Description 
This demo shows:  How to use the file system to read the filedata in directory resources in MiCO.


@par Directory contents  
    - Demos/filesystem/filesystem_ftfs/filesystem_ftfs.c      Filesystem_ftfs demo.
    - Demos/filesystem/filesystem_ftfs/mico_config.h          Provide constant definition and type declaration for MICO system running.



@par Hardware and Software environment      
    - This demo has been tested on MiCOKit-3239 board.

 /**
  @page " filesystem_fatfs "  demo
  
  @verbatim
  ******************** (C) COPYRIGHT 2016 MXCHIP MiCO SDK*******************
  * @file    filesystem_fatfs/readme.txt 
  * @author  MDWG (MiCO Documentation Working Group)
  * @version v2.4.x
  * @date    28-March-2017
  * @brief   Description of the  "filesystem_fatfs "  demo.
  ******************************************************************************


@par Demo Description 
This demo shows:  How to use the file system to read and write operations in MiCO


@par Directory contents  
    - Demos/filesystem/filesystem_fatfs/filesystem_fatfs.c     Filesystem_fatfs demo.
    - Demos/filesystem/filesystem_fatfs/mico_config.h          Provide constant definition and type declaration for MICO system running.

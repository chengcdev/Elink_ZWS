 ...
 *  @author chenb
 *  @brief
 *  1. If easylink force exit by user, append the operate rolling back to previous
 *   settings. 20180903 (function: easylink_thread())
 ******************************************************************************
 */

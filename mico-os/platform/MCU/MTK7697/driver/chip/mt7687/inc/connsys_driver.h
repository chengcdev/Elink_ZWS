...
typedef void (* connsys_allocate_pkt_t)(
    unsigned int allocate_len,
    void **pkt_ptr,
    unsigned char **payload_ptr);

typedef void (* connsys_input_pkt_t)(void *pkt_ptr, int port, unsigned int len);

struct connsys_callback_func {
    connsys_allocate_pkt_t  allocate_pkt_callback;
    connsys_input_pkt_t     input_pkt_callback;
};
...
void connsys_register_rx_handle(void *pfunc);
...
void connsys_register_allocate_pkt_callback(connsys_allocate_pkt_t func);
void connsys_register_input_pkt_callback(connsys_input_pkt_t func);

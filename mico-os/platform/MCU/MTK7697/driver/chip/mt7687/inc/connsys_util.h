...
#define WIFI_FW_ADDR_IN_FLASH   (0x30000000 + CM4_FLASH_N9_RAMCODE_ADDR) // only this address can be access by SYS BUS (DMA), 0x10000000 can only used for cache (XIP)
...
#define MT7637_PATCH_START_ADDR        0xD0000 //0x0008C000
...
int32_t connsys_util_get_inf_number(uint8_t *buf);

 ...
 * @param[in] sampling_rate is to set the output sampling rate. For more details, please refer to #hal_audio_sampling_rate_t().
 ...
 * @param[in] sampling_rate is to set input sampling rate. Please refers to #hal_audio_sampling_rate_t.
 * @return    #HAL_AUDIO_STATUS_OK, if sampling rate is valid
 ...
 * @param[in]  memory is a pointer to an allocated memory.
 * @return     #HAL_AUDIO_STATUS_OK, if OK.

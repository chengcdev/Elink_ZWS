 ...
 * @addtogroup GPIO
 * @{
 * This section provides introduction to the GPIO APIs, including terms and acronyms, features,
 ...
 *       The microcontroller pin connects the peripheral through multiplexer with which the pin can be specified to only one alternate function at a time. Detailed information about alternate functions of every pin can be got from hal_pinmux_define.h.
 *   \n

...
/** @defgroup hal_nvic_micro Define
  * @{
  */
/* @brief  This macro is used to query the current exception status of Cortext-M4.
 ...
 * @param[in] irq_number is the NVIC IRQ number, see #hal_nvic_irq_t.

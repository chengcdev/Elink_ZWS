...
ifeq ($(CONFIG_WIFI_LOWPOWER),1)
WIFI_LOWPOWER := -LOWPOWER
else
IPV6 :=
endif
ifneq ($(wildcard $(CURDIR)MX108$(IPV6)$(SOFTAP)$(WIFI_LOWPOWER).$(HOST_ARCH).$(TOOLCHAIN_NAME).release.a),)
$(NAME)_PREBUILT_LIBRARY += MX108$(IPV6)$(SOFTAP)$(WIFI_LOWPOWER).$(HOST_ARCH).$(TOOLCHAIN_NAME).release.a
else
# Build from source

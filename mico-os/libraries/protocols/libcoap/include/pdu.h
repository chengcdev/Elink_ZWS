...
#define COAP_DEFAULT_RESPONSE_TIMEOUT  1//2 /* response timeout in seconds */
#define COAP_DEFAULT_MAX_RETRANSMIT    2//4 /* max number of retransmissions */
#define COAP_DEFAULT_PORT              5683 /* CoAP default UDP port */
#define COAP_DEFAULT_PORT_CLIENT       5684 /* CoAP default UDP port */

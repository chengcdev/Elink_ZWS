...
#define coap_printf(M, ...) custom_log("coap", M, ##__VA_ARGS__)
...
#define info(M,...) custom_log("coap-info", M, ##__VA_ARGS__)
#define warn(M,...) custom_log("coap-warn", M, ##__VA_ARGS__)
#define debug(M,...) //custom_log("coap-debug", M, ##__VA_ARGS__)
